    ...
    public class ListaPokemon {
        ...
        static {
            pokemons.add(new Pokemon(3,"Venusaur", 100, new ArrayList<>(List.of(Tipo.AGUA, Tipo.VENENO)),
                    80, 82, 83, 100, 100, 80,
                    new ArrayList<>(List.of(
                            ListaAtaque.getListaAtaques().get(11)
                    ))));

            pokemons.add(new Pokemon(6, "Charizard", 100, new ArrayList<>(List.of(Tipo.FUEGO, Tipo.VOLADOR)),
                    78, 84, 78, 109, 85, 100,
                    new ArrayList<>(List.of(
                            ListaAtaque.getListaAtaques().get(20)
                            ))));

            pokemons.add(new Pokemon(9, "Blastoise", 100, new ArrayList<>(List.of(Tipo.AGUA)),
                    79, 83, 100, 85, 105, 78,
                    new ArrayList<>(List.of(
                            ListaAtaque.getListaAtaques().get(28)
                    ))));
